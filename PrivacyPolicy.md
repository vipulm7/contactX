...
To provide certain functionalities, ContactX uses third-party services from Google Play Services. These 3rd party services facilitates the Google sign-in process and enables it to read and write contacts from your Google account, and to backup and restore the database file to Google Drive.\
